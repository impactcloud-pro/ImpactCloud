...
export function SystemSettingsPage({ userRole }: SystemSettingsPageProps) {
  ...
  const isAdminWithReadOnlyPermissions = false;
        ...
        <Tabs value={state.activeTab} onValueChange={state.setActiveTab} className="w-full">
          ...
          <TabsContent value="integrations" className="space-y-6">
            <IntegrationsSettingsTab
              ...
              userRole={userRole}
              onIntegrationSettings={handlers.handleIntegrationSettings}
              onToggleIntegration={handlers.handleToggleIntegration}
            />
          </TabsContent>
